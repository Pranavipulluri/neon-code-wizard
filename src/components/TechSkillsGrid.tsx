...
// Tech Skills Grid Component with Real Icons
const TechSkillsGrid = () => {
  // Real Tech Icons Component
  const TechIcon = ({ name, size = 40 }) => {
    const icons = {
      ...
      "CSS": (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
          <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 4.406l-4.367.002 4.367-.002zm-.232 2.718L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531l-.232-2.718z" fill="#1572B6"/>
        </svg>
      ),
      "JavaScript": (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    return icons[name] || (
      <div className={`w-10 h-10 bg-gray-600 rounded flex items-center justify-center text-white text-xs`}>
        {name.charAt(0)}
      </div>
    );
  };
  ...
  const techCategories = {
    ...
    "Coding Languages": [
      ...
      { name: "R", color: "text-blue-500" },
      { name: "XML", color: "text-gray-400" }
    ],
    "AI/ML": [
      ...
      { name: "SpaCy", color: "text-cyan-400" },
      { name: "OpenCV", color: "text-purple-400" },
      { name: "YOLO", color: "text-yellow-400" },
      { name: "Neural Networks", color: "text-pink-400" },
      { name: "GANs", color: "text-purple-500" }
    ]
  };
    ...
    <div className="min-h-screen bg-black py-20 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
            <h2 className="neon-text text-3xl font-bold mb-10 text-cyan-400 text-center">Skills</h2>
            ...
            <div key={category} className="text-center">
              ...
              <div className="grid grid-cols-3 gap-6 max-w-sm mx-auto">
                {techs.map((tech, index) => (
                  <div
                    key={tech.name}
                    className="group relative bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-4 hover:border-cyan-400/50 transition-all duration-300 hover:scale-110 hover:bg-gray-800/60"
                  >
                    {/* Tech Icon */}
                    ...
                    {/* Tech Name */}
                    <div className={`text-sm font-medium ${tech.color} group-hover:text-white transition-colors duration-300`}>
                      {tech.name}
                    </div>
                    
                    {/* Hover Glow Effect */}
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/5 via-transparent to-purple-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl pointer-events-none" />
                  </div>
                ))}
              </div>
            </div>
